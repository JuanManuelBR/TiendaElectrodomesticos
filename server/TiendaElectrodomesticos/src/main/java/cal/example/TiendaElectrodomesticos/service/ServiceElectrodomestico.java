...
public class ServiceElectrodomestico {
    ...
    public boolean deleteElectrodomestico(int codigo) {
        Electrodomestico e = buscarElectrodomestico(codigo);
        ...
        if (e != null) {
            ...
            if (e instanceof Televisor) {
                ...
                if (tv.getControlRemoto() != null) {
                    ControlRemoto control = tv.getControlRemoto();
                    control.setTelevisor(null);
                    tv.setControlRemoto(null);
                }
            }
    ...
    public boolean asignarControlATelevisor(int codigoTelevisor, int codigoControl) {
        ...
        System.out.println("✅ Control asignado correctamente:");
        System.out.println("Televisor código: " + tv.getCodigo());
        System.out.println("Control código: " + control.getCodigo());
