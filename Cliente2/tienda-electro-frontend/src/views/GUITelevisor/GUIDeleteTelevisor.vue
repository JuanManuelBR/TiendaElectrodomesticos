    ...
    async buscar() {
      try {
        ...
        if (response.ok) {
          ...
          // Manejo de controles (igual que en C#: array de controles con numeroReferencia)
          if (data.controles && Array.isArray(data.controles)) {
            ...
            this.televisor.numeroReferenciaControles = codigos.join(',');
          } else {
            this.televisor.numeroReferenciaControles = '';
          }
    ...
    async eliminar() {
      ...
      try {
        ...
        if (response.ok) {
          ...
          // Limpiar todo el formulario incluyendo el código de búsqueda (igual que C#)
